...
cmd_display(13,0,"   ALT-Z quits the game.");
cmd_display(14,0,"     TAB shows the inventory screen.");
cmd_display(15,0,"     ESC pops up menus.");
cmd_display(16,0,"  Ctrl-J sets up your joystick.");
cmd_display(17,0,"      +  Increases volume.");
cmd_display(18,0,"      -  Decreases volume.");
case 1:
if (!cmd_have_key()) {
  jumpTo(1);
break;
