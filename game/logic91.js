...
if (cmd_isset(flag_new_room)) {
  ...
  cmd_set_key(0, 18, c29);
  cmd_set_key(0, 23, c36);
  cmd_set_key(0, 50, c11);
  cmd_set_key(0, 25, c13);
  cmd_set_key(0, 47, c8);
  cmd_set_key(0, 45, c31);
  cmd_set_key(0, 44, c1);
  cmd_set_key(3, 0, c17);
  cmd_set_key(5, 0, c9);
  cmd_set_key(9, 0, c10);
  ...
  cmd_assignn(var_joystick_sensitivity, 3);
  cmd_assignn(var_sound_volume, 0);
  cmd_configure_screen(1, 22, 0);
  cmd_set_string(s0, ">");
  cmd_set_cursor_char("_");
  cmd_assignn(var_max_score, 0);
